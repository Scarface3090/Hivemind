...
- [ ] Add dev tools to easily test and simulate the user actions and guesses for each game (eg: add /simulate 100 random player guesses for an active game, prematurely end an active game to trigger results screen etc)
